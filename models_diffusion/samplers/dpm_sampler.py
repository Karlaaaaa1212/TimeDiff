...
class DPMSolverSampler(object):
    ...
    def sample(self,
        ...
        # the net emits whatever it was TRAINED to emit; DPM-Solver has to be told which,
        # or a v-trained model gets read as if it had emitted x_start
        model_fn = model_wrapper(
            lambda x, t, c: self.model.forward(x, t, c),
            ns,
            model_type=self.diffusion_worker.parameterization,
